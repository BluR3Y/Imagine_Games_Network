...
def store_article_content(self, item):
    pass
...
def store_video_asset(self, item):
    pass
...
def store_user_review(self, item):
    pass
...
def store_region_release(self, item):
    pass

def store_region_rating(self, item):
    pass

def store_how_long_to_beat(self, item):
    pass

def store_object_wiki(self, item):
    pass

def store_wiki_navigation(self, item):
    pass

def store_map_object(self, item):
    pass

def store_map_item(self, item):
    pass
...
def store_poll_answer(self, item):
    pass
